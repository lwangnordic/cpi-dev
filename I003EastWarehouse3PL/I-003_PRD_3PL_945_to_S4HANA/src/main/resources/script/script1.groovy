...
//E1EDL24 = E1EDL24 + "<E1EDL24><POSNR>" + LX_POSNR[i].padLeft(5,"0") + "0</POSNR><LFIMG>" + REQQTY_LFIMG[i] + "</LFIMG><LGMNG>" + DELQTY_LGMNG[i] + "</LGMNG><CHARG>" + BATCH_CHARG[i] + "</CHARG><MATNR>" + MATERIAL_MATNR[i] + "</MATNR></E1EDL24>";
